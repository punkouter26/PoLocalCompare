...
Run from repo root: python download-models.py
...
IGNORE = [
    ".gitattributes",
    "README.md",
    "ndarray-cache-b16.json",  # alternate format; WebLLM uses ndarray-cache.json
]

BASE_DIR = Path(__file__).parent / "src" / "Client" / "PoLocalCompare.Client" / "wwwroot" / "models"
